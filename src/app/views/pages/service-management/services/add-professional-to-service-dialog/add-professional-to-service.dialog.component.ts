...
@Component({
	...
	selector: 'add-professional-to-service-dialog',
	templateUrl: './add-professional-to-service.dialog.component.html',
	styleUrls: ['./add-professional-to-service.dialog.component.scss'],
	changeDetection: ChangeDetectionStrategy.OnPush,
	encapsulation: ViewEncapsulation.None
})
export class AddProfessionalToServiceDialogComponent implements OnInit, OnDestroy {
